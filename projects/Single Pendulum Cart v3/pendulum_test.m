...
if balance_upright
    ...
    [t_traj_equib, x_traj_equib, u_traj_equib] = interface.stateFeedback([-8.94427 77.498 0 -31.0087 13.4644 0 0]', 2, 1200);
%     [t_traj_equib, x_traj_equib, u_traj_equib] = interface.stateFeedback([-8.944272 226.8021 0 -37.34317 14.29917 0 0]', 5, 1200);
