...
gamma = optFit(ode, [1 1 1 1 1 1], t_traj, x_traj, {'g1', 'g2', 'g3', 'g4', 'g5', 'g6'});
...
p.m = m;    % Do this _before_ creating the symbolic variable m
clear sys
...
% Have to convert the symfun into a string and do the substitution there to
% lose the time dependency! (i.e. above doesn't seem to work).
x_dot_str = char(sys.x_dot_sym);
x_dot_str = strrep(x_dot_str, 'diff(q1(t), t)', 'q1_dot');
sys.x_dot_sym = sym(x_dot_str);
% Need numeric version of ode, called like this: ode(t, x, u, param):
clear q1 q1_dot;    % Get rid of time dependence
syms q1 q1_dot
